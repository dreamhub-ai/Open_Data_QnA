...
from utilities.exp_utils import add_item_to_json

vertexai.init(project=PROJECT_ID, location=PG_REGION)
FILE_PATH = '/Users/yonierlich/repos/conversational/notebooks/evaluation/data/logs_for_reproduction.json'
...
class BuildSQLAgent(Agent, ABC):
    ...
    def build_sql(self, source_type, user_grouping, user_question, session_history, tables_schema, columns_schema,
                  similar_sql, max_output_tokens=2048, temperature=0.4, top_p=1, top_k=32):
        ...
        print('saving to json, in buildsql ')

        add_item_to_json(FILE_PATH, user_question, document_data)
